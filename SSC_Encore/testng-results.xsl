            ...
            <html xmlns="http://www.w3.org/1999/xhtml">
                ...
                <body>
                    <h2 style="margin-bottom: 5px;">
                        <xsl:value-of select="testng:getVariableSafe($testNgXslt.reportTitle, 'POC Test Execution Results: Vikas Garg')"/>
                    </h2>
                    <div>
                        <a href="overview.html" target="content"
                           onclick="javscript:clearAllSelections();">Results overview : Pie Chart 
                        </a>
                    </div>
                    <div>
